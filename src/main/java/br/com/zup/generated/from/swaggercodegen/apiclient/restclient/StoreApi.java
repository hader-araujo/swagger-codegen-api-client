...
@Api(value = "Store", description = "the Store API")
    public interface StoreApi {
            ...
            ResponseEntity<OrderDTO> getOrderById(@Min(1L) @Max(10L) @ApiParam(value = "ID of pet that needs to be fetched",required=true, allowableValues="") @PathVariable("orderId") Long orderId
);
